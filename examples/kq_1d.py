...
model_phi = models.MLP(
    [10, 1], param_dtype=jnp.complex64, kernel_init=models.complex_kernel_init
)
...
wave = wavefunctions.nn_complex(
    model_r.apply, model_phi.apply, n_nn_parameters, get_input=wavefunctions.get_input_k
)
