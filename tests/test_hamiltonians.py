...
from nn_eph import hamiltonians, hamiltonians_2, lattices, models, wavefunctions
...
phonon_occ_s = jnp.array(
    [[[np.random.randint(2) for _ in range(l_x)] for _ in range(l_y)] for _ in range(2)]
)
...
def test_holstein_1d():
    ham = hamiltonians.holstein(1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
        ...
        walker_1d, parameters_1d, wave_h_1d, lattice_1d, random_number
    )
...
def test_holstein_1d_2():
    ham = hamiltonians_2.holstein_1d(1.0, 1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
        ...
        walker_1d_2, gamma_1d, reference_h_1d, lattice_1d, random_number
    )
...
def test_long_range_1d():
    ham = hamiltonians.long_range(1.0, 1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
...
def test_long_range_1d_2():
    ham = hamiltonians_2.long_range_1d(1.0, 1.0, 1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
...
def test_ssh_1d():
    ham = hamiltonians.bond_ssh(1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
        ...
        walker_1d, parameters_1d, wave_s_1d, lattice_1d, random_number
    )
...
def test_bm_ssh_1d():
    ...
    (
        ...
        walker_1d, gamma_1d, reference_bm_s_1d, lattice_1d, random_number
    )
...
def test_holstein_2d():
    ...
    (
        ...
        walker_2d, parameters_2d, wave_2d, lattice_2d, random_number
    )
...
def test_ssh_2d():
    ...
    (
        ...
        walker_s_2d, parameters_s_2d, wave_s_2d, lattice_2d, random_number
    )
...
def test_ssh_2d_2():
    ham = hamiltonians_2.bond_ssh_2d(1.0, 1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
        ...
        walker_s_2d_2, gamma_s_2d, reference_s_2d, lattice_2d, random_number
    )
...
def test_long_range_2d_2():
    ham = hamiltonians_2.long_range_2d(1.0, 1.0, 1.0, 1.0)
    random_number = 0.5
    (
        energy,
        qp_weight,
        ...
        walker_2d_2, gamma_2d, reference_2d, lattice_2d, random_number
    )
...
def test_holstein_3d():
    ...
    (
        ...
        walker_3d, parameters_3d, wave_3d, lattice_3d, random_number
    )
